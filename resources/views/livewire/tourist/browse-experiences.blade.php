            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-6 wow fadeIn animated" data-wow-delay="0.2s">
                    <div class="img_wrapper">
                        ...
                        <div class="img_container">
                            <a href="detail-page.html">
                                <img src="img/tour_list_2.jpg" width="800" height="533" class="img-responsive" alt="">
                                <div class="short_info">
                ...
                <div class="col-md-4 col-sm-6 wow fadeIn animated" data-wow-delay="0.2s">
                    <div class="img_wrapper">
                        ...
                        <div class="img_container">
                            <a href="detail-page.html">
                                <img src="img/tour_list_9.jpg" width="800" height="533" class="img-responsive" alt="">
                                <div class="short_info">
                ...
                <div class="col-sm-6">
                    ...
                    <ul>
                        <li>
                            <div>
                                <a href="detail-page.html">
                                    <figure><img src="img/thumb_tabs_1.jpg" alt="thumb" class="img-rounded" width="60"
                                            height="60">
                                    </figure>
                        ...
                        <li>
                            <div>
                                <a href="detail-page.html">
                                    <figure><img src="img/thumb_tabs_2.jpg" alt="thumb" class="img-rounded" width="60"
                                            height="60">
                                    </figure>
                        ...
                        <li>
                            <div>
                                <a href="detail-page.html">
                                    <figure><img src="img/thumb_tabs_3.jpg" alt="thumb" class="img-rounded" width="60"
                                            height="60">
                                    </figure>
                ...
                <div class="col-sm-6">
                    ...
                    <ul>
                        <li>
                            <div>
                                <a href="detail-page.html">
                                    <figure><img src="img/thumb_tabs_4.jpg" alt="thumb" class="img-rounded" width="60"
                                            height="60">
                                    </figure>
                        ...
                        <li>
                            <div>
                                <a href="detail-page.html">
                                    <figure><img src="img/thumb_tabs_5.jpg" alt="thumb" class="img-rounded" width="60"
                                            height="60">
                                    </figure>
                        ...
                        <li>
                            <div>
                                <a href="detail-page.html">
                                    <figure><img src="img/thumb_tabs_6.jpg" alt="thumb" class="img-rounded" width="60"
                                            height="60">
                                    </figure>
